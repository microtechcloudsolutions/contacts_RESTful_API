...
const Hoek = require('joi/lib/node_modules/hoek');
const Any = require('joi/lib/types/any');
const Cast = require('joi/lib/cast');
const Errors = require('joi/lib/errors');
const Lazy = require('joi/lib/types/lazy');
const Ref = require('joi/lib/ref');
const Settings = require('joi/lib/types/any/settings');


// Declare internals

const internals = {
    alternatives: require('joi/lib/types/alternatives'),
    array: require('joi/lib/types/array'),
    boolean: require('joi/lib/types/boolean'),
    binary: require('joi/lib/types/binary'),
    date: require('joi/lib/types/date'),
    func: require('joi/lib/types/func'),
    number: require('joi/lib/types/number'),
    object: require('joi/lib/types/object'),
    string: require('joi/lib/types/string'),
    symbol: require('joi/lib/types/symbol')
};
...
internals.root = function () {
    ...
    root.version = require('joi/package.json').version;
