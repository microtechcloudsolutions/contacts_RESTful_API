...
const Net = require('joi/lib/types/string/node_modules/net');
const Hoek = require('joi/lib/types/string/node_modules/hoek');
const Any = require('joi/lib/types/any');
const Ref = require('joi/lib/ref');
const JoiDate = require('joi/lib/types/date');
const Uri = require('joi/lib/types/string/uri');
const Ip = require('joi/lib/types/string/ip');
...
internals.String = class extends Any {
    ...
    email(isEmailOptions) {
        ...
        return this._test('email', isEmailOptions, function (value, state, options) {
            ...
            Isemail = Isemail || require('joi/lib/types/string/node_modules/isemail');
