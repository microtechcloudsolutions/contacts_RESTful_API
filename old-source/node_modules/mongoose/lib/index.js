...
if (global.MONGOOSE_DRIVER_PATH) {
  require('mongoose/lib/driver').set(require(global.MONGOOSE_DRIVER_PATH));
} else {
  require('mongoose/lib/driver').set(require('mongoose/lib/drivers/node-mongodb-native'));
}

const Schema = require('mongoose/lib/schema');
const SchemaType = require('mongoose/lib/schematype');
const SchemaTypes = require('mongoose/lib/schema/index');
const VirtualType = require('mongoose/lib/virtualtype');
const STATES = require('mongoose/lib/connectionstate');
const Types = require('mongoose/lib/types');
...
const legacyPluralize = require('mongoose/lib/node_modules/mongoose-legacy-pluralize');
...
const shardingPlugin = require('mongoose/lib/plugins/sharding');
...
Mongoose.prototype.DocumentProvider = require('mongoose/lib/document_provider');
...
Mongoose.prototype.Error = require('mongoose/lib/error');
...
Mongoose.prototype.CastError = require('mongoose/lib/error/cast');
...
Mongoose.prototype.mongo = require('mongoose/lib/node_modules/mongodb');
...
Mongoose.prototype.mquery = require('mongoose/lib/node_modules/mquery');
